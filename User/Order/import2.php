    ...
    <div class="container font14">
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1800px;">
              ...
              <?php 
                $sqlsec = "select l.imp_id,l.imp_bill,l.order_id,brand_name,company,emp_name,l.pro_id,pro_name,unit_name,cate_name,l.qty,l.price,l.qty*l.price as total,l.note from listimports l left join product p on l.pro_id=p.pro_id left join categorydetail i on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id left join suppliers s on l.sup_id=s.sup_id join employees e on l.emp_id=e.emp_id left join brand b on p.brand_id=b.brand_id where l.emp_id='$emp_id';";
