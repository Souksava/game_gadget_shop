  ...
  <body >
    ...
    <div class="container font14">
        ...
        <div class="table-responsive">
            ...
            <?php
                $sql = "select detail_id,o.order_id,company,o.pro_id,pro_name,cate_name,o.qty,unit_name,o.price,o.qty*o.price as total,brand_name from orderdetail o left join product p on o.pro_id=p.pro_id left join categorydetail i on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id left join orders d on o.order_id=d.order_id left join suppliers s on d.sup_id=s.sup_id left join brand b on p.brand_id=b.brand_id where o.order_id='$order_id';";
