    ...
    <div class="container font14">
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <?php
                $sql = "select o.pro_id,pro_name,unit_name,cate_name,brand_name,o.qty,o.price,o.qty*o.price as total from orderdetail o left join product p on o.pro_id=p.pro_id left join categorydetail i on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id left join brand b on p.brand_id=b.brand_id where order_id='$order_id';";
