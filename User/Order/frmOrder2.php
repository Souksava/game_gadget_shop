        ...
        <div class="container font14">
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <?php
                    ...
                    $sql = "select detail_id,d.pro_id,pro_name,d.qty,d.price,unit_name,cate_name,brand_name,p.img_path from listorderdetail d left join product p on d.pro_id=p.pro_id left join categorydetail i on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id left join brand b on p.brand_id=b.brand_id where emp_id='$emp_id';";
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                ປະເພດ: <?php echo $row['cate_name']; ?> <br>
