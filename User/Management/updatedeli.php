...
<html>
    ...
    <body >
        ...
        <?php 
            $id = $_GET['id'];
            $sqlget = "select * from delivery where deli_id='$id';";
            $resultget = mysqli_query($link,$sqlget);
            $row = mysqli_fetch_array($resultget, MYSQLI_ASSOC);

        ?>
        <div class="container font14">
            <form action="updatedeli.php" id="update" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 form-group">
                        <label>ຊື່ບໍລິການຂົນສົ່ງ</label>
                        <input type="text" name="deli_name" class="form-control" value="<?php echo $row['deli_name']?>" placeholder="ຊື່ບໍລິການຂົນສົ່ງ">
                        <input type="hidden" name="deli_id" class="form-control" value="<?php echo $row['deli_id']?>" >
                    </div>
                    <div class="col-xs-12 col-sm-6 form-group">
            ...
            if(isset($_POST['btnUpdate'])){
                ...
                if(trim($deli_name) == ""){
                    ...
                    if($_FILES['img_path']['name'] == ""){
                        $sqlupdate = "update delivery set deli_name='$deli_name' where deli_id='$deli_id';";
                        ...
                        $sqlsec = "select img_path from delivery where deli_id='$deli_id';";
                        ...
                        //ສິນສຸດການຕັ້ງຊື່
                        $sqlupdate = "update delivery set deli_name='$deli_name',img_path='$pro_image' where deli_id='$deli_id';";
                        $resultupdate = mysqli_query($link,$sqlupdate);
                        if(!$resultupdate){
                            echo"<script>";
                            echo"alert('ບໍ່ສາມາດແກ້ໄຂຂໍ້ມູນໄດ້');";
