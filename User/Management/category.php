...
<html>
    ...
    <body >
        ...
        <?php
            if(isset($_POST['btnSave'])){
                ...
                if(trim($cate_name) == ""){
                    ...
                    $sqlckid = "select * from category where cate_name='$cate_name';";
                    ...
                    if(mysqli_num_rows($resultckid) > 0){
                        ...
                        $sqlinsert = "insert into category(cate_name,img_path) values('$cate_name','$pro_img');";
        ...
        <div class="container font14">
            <form action="category.php" id="fomrsearch" method="POST">
                <div style="width: 100%">
                    <input type="text" class="form-control" name="search" style="float: left;width: 50%;" placeholder="ລະຫັດ, ຊື່ປະເພດ">
        ...
        <div class="container font12">
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <?php
                    $sql = "select * from category where cate_id like '$search' or cate_name like '$search';";
                ...
                <div class="col mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h6 class="card-title">ລະຫັດ: <?php echo $row['cate_id']; ?>  ຊື່ປະເພດ: <?php echo $row['cate_name']; ?> </h6>
                            <p class="card-text">
                                <a href="updatecate.php?id=<?php echo $row['cate_id']; ?>" class="btn btn-outline-success" style="width: 100%;">ແກ້ໄຂ</a><br><br>
                                <a href="delcate.php?id=<?php echo $row['cate_id']; ?>" class="btn btn-outline-danger" style="width: 100%;" >ລົບ</a>
                            </p>
                        </div>
                    </div>
                </div>
