    ...
    <body >
        ...
        <div class="container font14">
            <div class="row">
                <div style="float: left;width: 50%;padding-left: 10px;">
                    <b>ປະເພດສິນຄ້າຍ່ອຍ</b>&nbsp <img src="../../icon/hidemenu.ico" width="10px">
                </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">ປະເພດສິນຄ້າຍ່ອຍ</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row" align="left">
                                            <div class="col-md-12 col-sm-6 form-group">
                                                <label>ຊື່ປະເພດສິນຄ້າຍ່ອຍ</label>
        ...
        <div class="container font12">
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <?php
                    $sql = "select cated_id,cated_name,cate_name from categorydetail d left join category c on d.cate_id=c.cate_id where cated_id like '$search' or cated_name like '$search' or cate_name like '$search';";
                ...
                <div class="col mb-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ຊື່ປະເພດຍ່ອຍ: <?php echo $row['cated_name']; ?> <br>
                                ປະເພດ: <?php echo $row['cate_name']; ?>
