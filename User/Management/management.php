    ...
    <div class="container" > 
        ...
        <div class="row font12">
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="category.php" class="font12">
        ...
        <div class="row font12">
            ...
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="productdetail.php" class="font12">
                     <img src="../../icon/detail.ico" width="60px" class="img-responsive" ><br><br>
                    <b> ລາຍລະອຽດສິນຄ້າ</b>
                </a>
            </div>
        </div>
        <div class="row font12">
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="product_special.php" class="font12">
                     <img src="../../icon/detail.ico" width="60px" class="img-responsive" ><br><br>
                    <b> ຈຸດພິເສດສິນຄ້າ</b>
                </a>
            </div>
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="product_function.php" class="font12">
                     <img src="../../icon/detail.ico" width="60px" class="img-responsive img-circle" ><br><br>
                    <b>ຟັງຊັນສິນຄ້າ</b>
                </a>
            </div>
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="product_model.php" class="font12">
                     <img src="../../icon/product.ico" width="60px" class="img-responsive" ><br><br>
                    <b>ໂມເດວສິນຄ້າ</b>
                </a>
            </div>
        </div>
        <div class="row font12">
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="product_property.php" class="font12">
                     <img src="../../icon/detail.ico" width="60px" class="img-responsive" ><br><br>
                    <b> ຄຸນສົມບັດສິນຄ້າ</b>
                </a>
            </div>
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="product_color.php" class="font12">
                     <img src="../../icon/color.ico" width="60px" class="img-responsive img-circle" ><br><br>
                    <b>ສີສິນຄ້າ</b>
                </a>
            </div>
            <div style="width: 33%;float: left;" align="center"><br>
        ...
        <div class="row font12">
            ...
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="delivery.php" class="font12">
                     <img src="../../icon/delivery.ico" width="60px" class="img-responsive" ><br><br>
                    <b> ຈັດສົ່ງ</b>
                </a>
            </div>
        </div>
        <div class="row font12">
            <div style="width: 33%;float: left;" align="center"><br>
                <a href="cover.php" class="font12">
                     <img src="../../icon/logo.ico" width="80px" class="img-responsive" ><br><br>
                    <b> ຮູບໜ້າປົກ</b>
                </a>
            </div>
        </div>
