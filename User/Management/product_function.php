...
<html>
    ...
    <body >
        ...
        <div class="container font14">
            <div class="row">
                <div style="float: left;width: 50%;padding-left: 10px;">
                    <b>ຟັງຊັນສິນຄ້າ</b>&nbsp <img src="../../icon/hidemenu.ico" width="10px">
                </div>
                <div align="right" style="width: 48%;float: right;">
                    <form action="product_function.php" id="form1" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">ຟັງຊັນສິນຄ້າ</h5>
                                        ...
                                        <div class="row" align="left">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <select name="func_id" id="" class="form-control">
                                                    <option value="">ເລືອກຊື່ຟັງຊັນສິນຄ້າ</option>
                                                    <?php
                                                        $sqlfunc = "select * from func_pro;";
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input type="text" name="function" class="form-control" placeholder="ຟັງຊັນສິນຄ້າ">
                                            </div>
                                        </div>
                                    </div>
            ...
            if(isset($_POST['btnSave'])){
                ...
                elseif(trim($functions) == ""){
                    ...
                    echo"</script>";
                        ...
                        $sqlinsert = "insert into function_product(pro_id,func_id,content) values('$pro_id','$func_id','$functions');";
        ...
        <div class="container font14">
            <form action="product_function.php" id="fomrsearch" method="POST">
                <div style="width: 100%">
                    <input type="text" class="form-control" name="search" style="float: left;width: 50%;" placeholder="ລະຫັດສິນຄ້າ, ຊື່ສິນຄ້າ, ຊື່ຟັງຊັນ">
        ...
        <div class="container font12">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                        <tr align="center">
                            <th colspan="6" scope="col" class="font14">ຟັງຊັນສິນຄ້າ</th>
                        </tr>
                    <?php 
                        $sql = "select function_id,func_name,f.pro_id,pro_name,content from function_product f left join func_pro o on f.func_id=o.func_id left join product p on f.pro_id=p.pro_id where f.pro_id like '$search' or pro_name like '$search' or func_name like '$search';";
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="updatefunc.php?id=<?php echo $row['function_id']; ?>">
                                    <img src="../../icon/edit.ico" alt="" width="20px">
                                </a>
                                <a href="delfunc.php?id=<?php echo $row['function_id']; ?>">
