    ...
    <body >
                                    ...
                                    <div class="modal-body">
                                        <div class="row" align="left">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input type="number" min="0" name="guarantee" class="form-control" placeholder="ເວລາຮັບປະກັນ">
                                            </div>
                                            <div class="col-md-12 form-group">
        ...
        <?php
            if(isset($_POST['btnSave'])){
                ...
                elseif(trim($brand_id) == ""){
                    ...
                    echo"<script>";
                    echo"alert('ກະລຸນາເລືອກຫົວໜ່ວຍເວລາ');";
                    echo"window.location.href='product.php';";
                    echo"</script>";
                }
                elseif(trim($guarantee) == ""){
                    echo"<script>";
                    echo"alert('ກະລຸນາໃສ່ການຮັບປະກັນ');";
                    echo"window.location.href='product.php';";
                    echo"</script>";
                }
                ...
                elseif(trim($status) == ""){
                    echo"<script>";
                    echo"alert('ກະລຸນາເລືອກສະຖານະສິນຄ້າ');";
                    echo"window.location.href='product.php';";
                    echo"</script>";
                }
                else {
                    ...
                    if(mysqli_num_rows($resultckid) > 0){
                        ...
                        $sqlinsert = "insert into product(pro_id,pro_name,qty,price,cated_id,unit_id,brand_id,guarantee,type,promotion,qtyalert,img_path,status) values('$pro_id','$pro_name','$qty','$price','$cate_id','$unit_id','$brand_id','$guarantee','$type','$promotion','$qtyalert','$pro_img','$status')";
        ...
        <div class="container font12">
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <?php
                    $sql = "select pro_id,pro_name,p.qty,price,p.cated_id,cated_name,p.unit_id,unit_name,p.brand_id,brand_name,cate_name,guarantee,type,promotion,qtyalert,p.img_path,p.status from product p left join categorydetail d on p.cated_id=d.cated_id left join category c on d.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id left join brand b on p.brand_id=b.brand_id where pro_id like '$search' or pro_name like '$search' or d.cated_name like '$search' or unit_name like '$search' or brand_name like '$search' or c.cate_name like '$search' or p.status like '$search';";
                ...
                <div class="col mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ຊື່ສິນຄ້າ: <?php echo $row['pro_name']; ?> <br>  ປະເພດ: <?php echo $row['cate_name']; ?> <?php echo $row['cated_name']; ?> <br>
                                ຍີ່ຫໍ້: <?php echo $row['brand_name']; ?> ຈຳນວນ: <?php echo $row['qty']; ?>  <?php echo $row['unit_name']; ?> <br>
                                ລາຄາ: <?php echo number_format($row['price'],2); ?>  ສ່ວນຫຼຸດ: <?php echo number_format($row['promotion'],2); ?><br>
                                ຮັບປະກັນ: <?php echo $row['guarantee']; ?>  <?php echo $row['type']; ?><br>
                                ເງື່ອນໄຂການສັ່ງຊື້: <?php echo $row['qtyalert']; ?><br>
                                ສະຖານະສິນຄ້າ: <?php echo $row['status']; ?><br>
                                <br><br>
