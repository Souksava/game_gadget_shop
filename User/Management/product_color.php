...
<html>
    ...
    <body >
        ...
        <div class="container font14">
            <div class="row">
                <div style="float: left;width: 50%;padding-left: 10px;">
                    <b>ສີສິນຄ້າ</b>&nbsp <img src="../../icon/hidemenu.ico" width="10px">
                </div>
                <div align="right" style="width: 48%;float: right;">
                    <form action="product_color.php" id="form1" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">ສີສິນຄ້າ</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row" align="left">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input type="text" name="color_name" class="form-control" placeholder="ສີສິນຄ້າ">
                                            </div>
                                            <div class="col-md-12 form-group">
        ...
        <?php
            if(isset($_POST['btnSave'])){
                ...
                elseif(trim($_FILES['img_path']['name']) == ""){
                    ...
                    $sqlckid = "select * from product_color where pro_id='$pro_id' and color_name='$color_name';";
                    $resultckid = mysqli_query($link,$sqlckid);
                    if(mysqli_num_rows($resultckid) > 0){
                        echo"<script>";
                        echo"alert('ບໍ່ສາມາດບັນທຶກຂໍ້ມູນໄດ້ ເນື່ອງຈາກສິນຄ້າ ແລະ ສີນີ້ມີຢູ່ແລ້ວ');";
                        echo"window.location.href='product_color.php';";
                        echo"</script>";
                    }
                    else {
                        ...
                        $sqlinsert = "insert into product_color(pro_id,color_name,img_path) values('$pro_id','$color_name','$pro_img');";
        ...
        <div class="container font14">
            <form action="product_color.php" id="fomrsearch" method="POST">
                <div style="width: 100%">
                    <input type="text" class="form-control" name="search" style="float: left;width: 50%;" placeholder="ລະຫັດສິນຄ້າ, ຊື່ສິນຄ້າ, ສີສິນຄ້າ">
        ...
        <div class="container font12">
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <?php
                    $sql = "select color_id,color_name,c.pro_id,pro_name,c.img_path from product_color c left join product p on c.pro_id=p.pro_id where c.pro_id like '$search' or pro_name like '$search' or color_name like '$search';";
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                ສີສິນຄ້າ: <?php echo $row['color_name']; ?> <br>
                                <br><br>
                                <a href="updatecolor.php?id=<?php echo $row['color_id']; ?>" class="btn btn-outline-success" style="width: 100%;">ແກ້ໄຂ</a><br><br>
                                <a href="delcolor.php?id=<?php echo $row['color_id']; ?>" class="btn btn-outline-danger" style="width: 100%;" >ລົບ</a>
                            </p>
                        </div>
                    </div>
                </div>
