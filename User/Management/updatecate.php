...
<html>
    ...
    <body >
        ...
        <div class="container font14">
            <form action="updatecate.php" id="update" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 form-group">
                        <label>ຊື່ປະເພດສິນຄ້າ</label>
                        <input type="text" name="cate_name" class="form-control" value="<?php echo $row['cate_name']?>" placeholder="ຊື່ປະເພດສິນຄ້າ">
                        <input type="hidden" name="cate_id" class="form-control" value="<?php echo $row['cate_id']?>" >
                    </div>
                    <div class="col-xs-12 col-sm-6 form-group">
                        <label>ຮູບພາບປະເພດສິນຄ້າ</label>
            ...
            if(isset($_POST['btnUpdate'])){
                ...
                if(trim($cate_name) == ""){
                    ...
                    if($_FILES['img_path']['name'] == ""){
                        ...
                        $sqlsec = "select img_path from category where cate_id='$cate_id';";
