...
function ShowData(){
    ...
    if(isset($_POST['btnAll'])){
        ...
        <tr class="fontblack18">
            <td colspan="7" align="right"><h3><b>ລວມມູນຄ່າ : </b></h3></td>
            <td colspan="4" align="right"><h3><b>'.number_format($amount,2).' ກີບ</h3> </b></td>
        </tr>  
        <tr class="fontblack18">
            <td colspan="7" align="right"><h3><b>ຮັບຈາກການຂົນສົ່ງ : </b></h3></td>
            <td colspan="4" align="right"><h3><b>'.number_format($row4["delivery"],2).' ກີບ</h3> </b></td>
        </tr>    
        <tr class="fontblack18">
