                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table" style="width: 1100px;">
                            ...
                            <?php 
                                $sqlshow = "select p.pro_id,pro_name,cate_name,cated_name,brand_name,unit_name,p.img_path,p.qty,p.price,p.price - p.promotion as newprice,p.promotion,(p.promotion/p.price) * 100 as perzen,p.qty*(p.price - p.promotion) as total from  product p left join categorydetail i  on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join brand b on p.brand_id=b.brand_id left join unit u on p.unit_id=u.unit_id where p.pro_id like '$Search' or pro_name like '$Search' or brand_name like '$Search' or unit_name like '$Search' or cate_name like '$Search';";
                            ...
                            <tr>
                                ...
                                <td><?php echo $rowshow['cate_name']; ?> <?php echo $rowshow['brand_name']; ?> <?php echo $rowshow['pro_name']; ?> <?php echo $rowshow['cated_name']; ?></td>
                                <td> 
                            ...
                            <?php 
                                ...
                                $sqlsum = "select sum(p.qty*(p.price - p.promotion)) as amount from  product p left join categorydetail i  on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join brand b on p.brand_id=b.brand_id left join unit u on p.unit_id=u.unit_id where p.pro_id like '$Search' or pro_name like '$Search' or brand_name like '$Search' or unit_name like '$Search' or cate_name like '$Search';";
