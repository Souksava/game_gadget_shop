    ...
    <div class="header">
      ...
      <div class="container">
        <div class="row font12">
            ...
            <div style="width: 33%;float: left;" align="center">
                <a href="Order/order.php" class="font12">
                    ...
                    <?php 
                     ...
                     ?>
                   <b>ສັ່ງຊື້ ແລະ ນຳເຂົ້າ</b>&nbsp&nbsp<span class="badge badge-success"><?php echo $rowck['ck'];?> </span>
                   <span class="badge badge-danger"><?php echo $rowck2['ck'];?></span>
                </a>
            </div>
            <div style="width: 33%;float: left;" align="center">
                <a href="Service/service.php" class="font12">
                     ...
                     <?php 
                        ...
                        $rowck = mysqli_fetch_array($resultck, MYSQLI_ASSOC);
                     ?>
                    <b>ບໍລິການ</b>&nbsp&nbsp<span class="badge badge-danger"><?php echo $rowck['ck'];?></span>
                </a>
            </div>
        </div><br>
        <div class="row font12">
