...
<html>
  ...
  <body >
    <!-- head -->
      <div class="header">
        <div class="container">
                <a href="service.php" class="tapbar" align="left">
                ...
                <form action="sale.php" id="form1" method="POST">
                    <div class="input-group">        
                        ...
                        <div class="input-group-prepend">
                            <button type="submit" name="btnAdd" class="btn btn-outline-danger">ເພີ່ມລາຍການ</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="container-fluid font12">
		<div class="row">
			<div class="col-md-8">
                <a href="sell_borad.php" target="_blank">ລາຍການສິນຄ້າ</a>
