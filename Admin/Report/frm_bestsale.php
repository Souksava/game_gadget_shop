        ...
        <div class="container font14">
            ...
            <div class="table-responsive">
                <table class="table" style="width: 1200px;">
                    ...
                    <?php
                        $sql = "select pro_name,sum(d.qty) as total_qty,sum(d.qty*d.price) as total,count(d.pro_id) as count_product,p.img_path,cate_name,cated_name,brand_name,unit_name from selldetail d left join sell s on d.sell_id=s.sell_id left join product p on d.pro_id=p.pro_id left join categorydetail i on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join brand b on p.brand_id=b.brand_id left join unit u on p.unit_id=u.unit_id group by d.pro_id order by count(d.pro_id) desc;";
                    ...
                    <?php
                        ...
                        $sql2 = "select sum(d.qty*d.price) as amount from selldetail d left join sell s on d.sell_id=s.sell_id left join product p on d.pro_id=p.pro_id left join categorydetail i on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join brand b on p.brand_id=b.brand_id left join unit u on p.unit_id=u.unit_id;";
            ...
            <div class="table-responsive">
                <table class="table" style="width: 1200px;">
                    ...
                    <?php
                        ...
                        $sql2 = "select sum(d.qty*d.price) as amount from selldetail d left join sell s on d.sell_id=s.sell_id left join product p on d.pro_id=p.pro_id left join categorydetail i on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join brand b on p.brand_id=b.brand_id left join unit u on p.unit_id=u.unit_id where sell_date between '$date1' and '$date2';";
                        $result2 = mysqli_query($link,$sql2);
                        $row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC);
