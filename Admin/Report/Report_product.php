...
function ShowData(){
    ...
    if(isset($_POST['btnReport'])){
        ...
        $sqlAmount = "select sum(p.qty*(p.price - p.promotion)) as amount from  product p left join categorydetail i  on p.cated_id=i.cated_id left join category c on i.cate_id=c.cate_id left join brand b on p.brand_id=b.brand_id left join unit u on p.unit_id=u.unit_id where p.pro_id like '$Search' or pro_name like '$Search' or brand_name like '$Search' or unit_name like '$Search' or cate_name like '$Search';";
