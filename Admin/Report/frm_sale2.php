<?php
   ...
   $sqlsell = "select sell_id,cus_name,sell_date,sell_time,amount,s.status,status_cash,s.img_path,sell_type,cupon_key,cupon_price,place_deli,emp_name from sell s left join customers c on s.cus_id=c.cus_id left join employees e on s.emp_id=e.emp_id where s.sell_id='$sell_id';";
